              ...
              <div class="tab_panel">
                ...
                <div class="tab_panel_content">
                  ...
                  <div class="campus_footer_content d-flex flex-row align-items-center justify-content-start">
                    ...
                    <img src="<?php echo get_template_directry_uri(); ?>/images/clock.png"><span><?php the_time('Y年n月j日') ?></span>
                  </div>
                  <hr>
                  <div class="social_share">
                    <!-- <img src="images/facebook-square-brands.png" alt=""> -->
                    <!-- <img src="images/twitter-square-brands.png" alt=""> -->
                    <img src="<?php echo get_template_directry_uri(); ?>/images/facebook-square-brands.png" alt="">
                    <img src="<?php echo get_template_directry_uri(); ?>/images/twitter-square-brands.png" alt="">
                  </div>
                </div>
              </div>
            </div>
